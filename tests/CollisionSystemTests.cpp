...
Test(CollisionSystem, avanded_CollisionSystem_collision_after_one)
{
    Registry registry;
    auto entity1 = registry.spawn_entity();
    auto entity2 = registry.spawn_entity();
    auto entity3 = registry.spawn_entity();
    ...
    registry.add_component<Component::Position>(entity2, Component::Position(0, 0));
    registry.add_component<Component::Collision>(entity2, Component::Collision(10, 10));
    registry.add_component<Component::Position>(entity3, Component::Position(0, 0));
    registry.add_component<Component::Collision>(entity3, Component::Collision(10, 10));

    registry.add_system<Component::Position, Component::Collision>(CollisionSystem());

    registry.run_systems();

    cr_assert_eq(registry.get_components<Component::Collision>()[entity1].value().entities_in_collision.size(), 2);
    cr_assert_eq(registry.get_components<Component::Collision>()[entity2].value().entities_in_collision.size(), 2);
    cr_assert_eq(registry.get_components<Component::Collision>()[entity3].value().entities_in_collision.size(), 2);
    ...
    registry.get_components<Component::Position>()[entity1].value().x = 50;

    registry.run_systems();

    cr_assert_eq(registry.get_components<Component::Collision>()[entity1].value().entities_in_collision.size(), 0);
    cr_assert_eq(registry.get_components<Component::Collision>()[entity2].value().entities_in_collision.size(), 1);
    cr_assert_eq(registry.get_components<Component::Collision>()[entity3].value().entities_in_collision.size(), 1);
}
