...
Test(Registry, 2_spawn_exportToMessages)
{
    ...
    reg.add_component<Component::Drawable>(entity2, Component::Drawable("ZBOUBZBOUB.png", nullptr, sf::IntRect(0, 0, 0, 0), Component::Position(0, 0), false, reg.get_assets().get_texture("ZBOUBZBOUB.png")));
