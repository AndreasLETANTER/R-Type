...
int main(const int ac, const char **av)
{
    ...
    registry.add_component<Component::Position>(registry.entity_from_index(3), Component::Position(100, 100));
    ...
    registry.add_component<Component::AutoMove>(registry.entity_from_index(3), Component::AutoMove(Component::Position(100, 100), Component::Position(100, 100)));
