    ...
    EntityClass EntityClassFactory::CreateEntityClass(EntityClasses entityClass) {
        switch (entityClass) {
            case EntityClasses::NUGO:
                return EntityClass("SpaceShips.gif", "BulletSprite.png", Component::Position(102, 57), sf::IntRect(0, 2, 34, 16), 150, 15, 750, 1, ShootingPattern::LINEAR);
            case EntityClasses::ANDREAS:
                return EntityClass("SpaceShips.gif", "BulletSprite.png", Component::Position(102, 57), sf::IntRect(0, 19, 34, 16), 50, 1, 300, 7, ShootingPattern::LINEAR);
            ...
            case EntityClasses::LOUIS:
                return EntityClass("SpaceShips.gif", "BulletSprite.png", Component::Position(102, 57), sf::IntRect(0, 53, 34, 16), 75, 5, 500, 3, ShootingPattern::LINEAR);
