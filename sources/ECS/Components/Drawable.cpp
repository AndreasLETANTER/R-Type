...
Component::Drawable::Drawable(std::string spriteName, sf::RenderWindow *window, sf::IntRect rect, Component::Position scale, bool needToLoadTexture, sf::Texture &texture)
{
    this->spriteName = spriteName;
    this->window = window;
    this->rect = rect;
    this->scale = scale;
    (void)needToLoadTexture;
