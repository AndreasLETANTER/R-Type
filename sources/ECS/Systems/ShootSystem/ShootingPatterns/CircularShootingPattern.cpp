...
void CircularShootingPattern::shoot(Registry &registry, Component::Shoot &shoot, Component::Position &pos, Component::Drawable &draw)
{
    ...
    if (shoot.canShoot == true && (shoot.keyPressed == sf::Keyboard::Space || shoot.direction == -1) && elapsedTime >= shoot.shootDelay) {
        ...
        createProjectile(registry, draw, shoot.bulletSpriteName, Component::Position(x - projectileDraw.value().sprite.getTextureRect().width - 1, y - projectileDraw.value().sprite.getTextureRect().height - 1), Component::Position(0, 0), shoot.damage);
        ...
        createProjectile(registry, draw, shoot.bulletSpriteName, Component::Position(x + projectileDraw.value().sprite.getTextureRect().width + 15, y - projectileDraw.value().sprite.getTextureRect().height - 1), Component::Position(1920, 0), shoot.damage);
        ...
        createProjectile(registry, draw, shoot.bulletSpriteName, Component::Position(x + projectileDraw.value().sprite.getTextureRect().width + 15, y + projectileDraw.value().sprite.getTextureRect().height + 1), Component::Position(1920, 1080), shoot.damage);
        ...
        createProjectile(registry, draw, shoot.bulletSpriteName, Component::Position(x - projectileDraw.value().sprite.getTextureRect().width - 1, y + projectileDraw.value().sprite.getTextureRect().height + 1), Component::Position(0, 1080), shoot.damage);
