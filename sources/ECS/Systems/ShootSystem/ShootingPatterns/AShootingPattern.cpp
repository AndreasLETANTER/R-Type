...
void AShootingPattern::createProjectile(Registry &registry, Component::Drawable &draw, std::string bulletSpriteName, Component::Position initialPos, Component::Position endPos, size_t damage, int playerId, unsigned int groupId)
{
    ...
    registry.add_component<Component::Projectile>(projectile, Component::Projectile(initialPos, std::move(endPos), 10, damage, playerId));
